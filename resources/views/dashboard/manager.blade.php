<x-app-layout>
    ...
    <x-page-header
        ...
        subtitle="Portfolio health, approvals, and compliance at a glance." />
    ...
    <script type="module">
        ...
        initChart('chart-distribution', {
            ...
            options: {
                ...
                plugins: {
                    ...
                    tooltip: { callbacks: { label: (ctx) => ` ${ctx.label}: ${ctx.raw} assets` } },
                },
            },
        });
        ...
        initChart('chart-licenses', {
            ...
            data: {
                ...
                datasets: [
                    { label: 'Used', data: licenseData.top.map((l) => l.used), backgroundColor: C.secondary, borderRadius: 6, maxBarThickness: 28 },
                    { label: 'Available', data: licenseData.top.map((l) => l.total - l.used), backgroundColor: C.gray, borderRadius: 6, maxBarThickness: 28 },
                ],
            },
            options: {
                responsive: true,
