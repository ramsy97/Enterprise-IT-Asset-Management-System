<x-app-layout>
    ...
    <x-page-header
        title="Edit User"
        subtitle="Update account details and role assignment." />
        ...
        <x-card title="Account Details">
            <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="password" id="password" name="password" placeholder="Leave blank to keep current" class="input-field">
                </div>
                ...
                <div>
                    ...
                    <input type="text" id="department" name="department" value="{{ old('department', $user->department) }}" class="input-field">
                </div>

                <div>
                    <label for="position" class="label-field">Position</label>
                    <input type="text" id="position" name="position" value="{{ old('position', $user->position) }}" class="input-field">
                </div>

                <div>
                    <label for="phone" class="label-field">Phone</label>
                    <input type="text" id="phone" name="phone" value="{{ old('phone', $user->phone) }}" class="input-field">
                </div>
            </div>
        </x-card>
